...
- The lab also gave students training on how to effectively communicate in a software team.
- One improvement we suggest is to have a set deadline for creating groups and automatically assigning groups after the deadline. This way last minute grouping issues and scrambling can be avoided.
